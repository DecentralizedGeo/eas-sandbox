...
const MOCK_PM_DATA = '["lat is generated by pm", "long is generated by pm", "timestamp is generated by pm", "file_hash is generated by pm"]'
  ...
  useEffect(() => {
    const connectAndAttest = async () => {
      ...
      try {
        ...
        const pmDataParsed = JSON.parse(MOCK_PM_DATA);
        ...
        const attestationData: OnChainAttestationData = {
          ...
          schemaString: "string lat, string long, string timestamp, string file_hash, string ipfs_cid",
          dataToEncode: [
            // lat is generated by pm
            { name: "lat", value: pmDataParsed[0].toString(), type: "string" },
            // long is generated by pm
            { name: "long", value: pmDataParsed[1].toString(), type: "string" },
            // timestamp is generated by pm
            { name: "timestamp", value: pmDataParsed[2].toString(), type: "string" },
            // file_hash is generated by pm
            { name: "file_hash", value: pmDataParsed[3].toString(), type: "string" },
            // file_hash is generated by w3up service
            { name: "ipfs_cid", value: "file_hash is generated by w3up service", type: "string" },
          ]
        };
